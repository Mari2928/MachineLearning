...
def run_softmax_on_MNIST(temp_parameter=1.0):
    """
...
test_error_pca10 = compute_test_error(test_cube, test_y, theta, temp_parameter)
print('test_error_pca10=', test_error_pca10)