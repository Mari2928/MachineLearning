...
ALPHA = 1 #0.1  # learning rate for training
...
def run_episode(for_training):
    ...
    while not terminal:
        ...
        current_state_1, current_state_2 = dict_room_desc[current_room_desc], \
        ...
        if for_training:
            ...
            tabular_q_learning(q_func, current_state_1, current_state_2, action_index,
                       object_index, reward, next_state_1, current_state_2,
                       terminal)
            pass
